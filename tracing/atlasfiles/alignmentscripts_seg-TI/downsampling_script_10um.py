...
RegistrationResamplingParameter488["sink"] =  os.path.join(BaseDirectory, 'autofluo_resampled_10um.tif');
...
RegistrationResamplingParameter647["sink"]=os.path.join(BaseDirectory,'signal_resampled_10um.tif');
...
RegistrationResamplingParameterred["sink"]=os.path.join(BaseDirectory,'seg-TI_resampled_10um.tif');    
