...
% save('ipsi_subnuclei_ROIS1.mat','subnucleiROIs')
...
% figure;
% bar(celltypequant_fraction_norm(ordering,:));

% save('ipsi_quantification.mat','quantification','area');




load('ipsi_quantification.mat');
...
figure;
imagesc(celltypequant_fraction)
title('Retro1_ipsi_quant')
print(gcf,['figure_exports_fixed9/Retro1_ipsi_quant_heatmap'],'-dpdf','-r1000')
close gcf
...
print(gcf,['figure_exports_fixed9/Retro1_ipsi_quant_bars'],'-dpdf','-r1000')
close gcf

figure;
imagesc(celltypequant_fraction_norm)
title('Retro1_contra_quant_norm')
print(gcf,['figure_exports_fixed9/Retro1_ipsi_quant_norm_heatmap'],'-dpdf','-r1000')
close gcf
...
title('Retro1_contra_quant_norm')
print(gcf,['figure_exports_fixed9/Retro1_ispi_quant_norm_bars'],'-dpdf','-r1000')
close gcf



Fnorm_ex_ipsi=celltypequant_fraction_norm;
F_ex_ipsi=celltypequant_fraction;

save('quantification_output_ipsi.mat','Fnorm_ex_ipsi','F_ex_ipsi')
